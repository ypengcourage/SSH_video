...
<div class="catalog">
	<div class="container">
		...
		<c:forEach items="${videoList}" var="video" >
			<div class="chapter">
				<p class="biaoti"><a href="${pageContext.request.contextPath }/front/video/video_index.action?videoId=${video.id}&subjectId=${subjectId}">${video.videoTitle}</a></p>
				...
				<div class="v-info">
					...
					<span class="duration"><img src="${pageContext.request.contextPath }/static/img/player.png" alt="">
					${video.videoLengthstr}</span>
				</div>
			</div>
		</c:forEach>
