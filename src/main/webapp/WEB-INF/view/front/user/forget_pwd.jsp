...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="${pageContext.request.contextPath }/front/user/user_forgetpwd.action" method="post" >
...
<%@include file="../include/script.html"%>
    <script type="text/javascript">
		function submitEmail(){
			...
			//改为ajax提交邮箱
			if(email!=null&&email!=''){
				$.post('${pageContext.request.contextPath }/admin/ajax/ajax_sendEmail.action',{email:email},function(data){
					if(data.success){
